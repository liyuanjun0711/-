window.MARKET_BRIEFING_DATA = {
  "date": "2026-08-05",
  "portfolioVersion": "portfolio-2026-08-05-premarket-v1",
  "time": "2026-08-05盘前完成执行版。13个场内标的仍为8月4日真实收盘，腾讯、东方财富报价与两套日K交叉核对；161226和005827已更新到8月4日披露净值，运行时开放式基金接口仍失败。",
  "lastUpdated": "2026-08-05 08:40 北京时间",
  "apiBase": "https://daily-briefing-blue.vercel.app",
  "refreshInterval": 10000,
  "oneLine": "结论：8月5日不追科技反弹，先处理161226约19.0%的静态溢价，再看562350和002090相对弱势触发。隔夜标普、道指、纳指均创新高，布油跌5.3%，外部情绪偏正面；但A股8月4日仍是成长强、上证与港股科技偏弱的分化结构。没有卖出成交就不买；卖出资金先留现金。仅供个人复盘参考。",
  "tradeDecision": [
    {
      "type": "高溢价第一顺位",
      "title": "国投白银LOF 161226：约19.0%静态溢价继续减风险",
      "conclusion": "8月4日场内收1.899；8月4日单位净值1.5955，静态溢价约19.0%，且申购仍暂停。",
  ...
  "tradePlan": [
    ...
    {
      "title": "美股创新高与油价回落改善外部风险偏好",
      "basis": "8月4日标普500涨1.8%、纳指涨2.6%、道指涨1.7%，三者均创新高；AP报道布伦特原油跌5.3%至79.36美元，10年期美债收益率降至4.62%。",
      "inference": "盈利与油价回落支持成长风险偏好，但地缘冲突和高估值仍在，不能把隔夜强势直接外推成A股连续上涨。",
  ...
  "noTradeList": [
    ...
    "不补161226。约19.0%的静态溢价已按8月4日最新披露净值1.5955重算，申购仍暂停。",
  ...
  "holdings": [
    ...
    },
    {
      ...
      "reason": "8月4日场内收1.899，对8月4日净值1.5955静态溢价约19.0%，申购仍暂停。",
      "riskLevel": "高"
    },
    {
      "name": "稀有金属ETF广发",
  ...
  "watchlist": [
    ...
    },
    {
      ...
      "type": "open_fund",
      "sector": "开放式基金",
      "status": "已有8月4日披露净值，运行时接口失败",
      "reason": "8月4日单位净值1.5259、单日涨1.23%；开放式基金不提供盘中K线，网页代理当前返回失败态。",
      ...
      "lastHigh": null,
      "lastLow": null,
      "lastChangePercent": 1.23,
      "lastSource": "东方财富基金历史净值，2026-08-04；运行时/api/fund为失败态",
  ...
  "newsItems": [
    ...
    },
    {
      ...
      "summary": "已确认事实：8月4日场内收1.899、单位净值1.5955，申购暂停。基于事实的判断：约19.0%的静态溢价仍是持仓第一风险，不因基础资产或场内价格上涨而消失。",
      "relatedStocks": [
        "161226"
      ],
      "sector": "白银",
    ...
    {
      "title": "美股三大指数创新高，油价与美债收益率回落",
      "source": "AP",
      "publishTime": "2026-08-05T05:00:03+08:00",
      "summary": "已确认事实：8月4日标普500涨1.8%、纳指涨2.6%、道指涨1.7%，三者创新高；布伦特原油跌5.3%至79.36美元，10年期美债收益率降至4.62%。基于事实的判断：外部风险偏好改善，但地缘与估值风险未消失，不足以支持A股追高。",
      "relatedStocks": [
        "164701",
        "161226",
        "159740"
      ],
      "sector": "过去24小时 / 全球利率 / 贵金属 / 科技",
      "relation": "risk",
    ...
    },
    {
      ...
      "source": "东方财富基金 / 自有代理",
      "publishTime": "2026-08-04",
      "summary": "已确认事实：005827于8月4日单位净值1.5259、单日涨1.23%；运行时开放式基金接口仍返回失败态。基于事实的判断：只展示已披露净值，不提供盘中方向或假K线。",
      "relatedStocks": [
        "005827"
      ],
      "sector": "开放式基金",
  ...
  "reasoning": [
    {
      "title": "溢价风险优先于场内涨跌",
      "basis": "161226场内收1.899、8月4日净值1.5955，静态溢价约19.0%。",
    ...
    {
      "title": "失败态优先于预测",
      "basis": "005827运行时真实基金接口仍返回失败；最新可核验的是8月4日披露净值1.5259。",
  ...
  "learningFramework": [
    ...
    {
      "title": "LOF看净值与价格两条线",
      "basis": "161226场内1.899，最新披露净值1.5955。",
  ...
  "sources": [
    {
      ...
      "note": "2026-08-05 08:34批量请求失败；单标的quote返回真实8月4日收盘，OF005827返回501。失败时页面必须显示失败态"
    },
    {
    ...
    },
    {
      ...
      "url": "https://api.fund.eastmoney.com/f10/lsjz?fundCode=161226&pageIndex=1&pageSize=5",
      "note": "2026-08-04单位净值1.5955，申购暂停；相对8月4日场内收盘静态溢价约19.0%"
    },
    {
      "name": "东方财富基金：005827历史净值",
      "url": "https://api.fund.eastmoney.com/f10/lsjz?fundCode=005827&pageIndex=1&pageSize=5",
      "note": "2026-08-04单位净值1.5259、单日涨1.23%；运行时接口仍失败"
    },
    {
      "name": "AP：2026-08-04美股、油价与美债",
      "url": "https://apnews.com/article/stocks-markets-dollar-yen-trump-iran-war-fbbe6128d618509e33d45a493c2615b1",
      "note": "收盘稿于2026-08-05 05:00北京时间更新；标普涨1.8%、纳指涨2.6%、道指涨1.7%并创新高，布伦特原油跌5.3%，10年期美债收益率降至4.62%"
    },
    {
