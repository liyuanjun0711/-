window.MARKET_BRIEFING_DATA = {
  "date": "2026-09-01",
  "portfolioVersion": "portfolio-2026-09-01-midday-proxy-failed-v1",
  "time": "2026-09-01 12:30北京时点核验：本环境无法连接自有代理，未取得新的可验证盘中报价；页面仅保留8月31日逐只核对过的真实收盘与当日净值，绝不将其标为实时。持仓名单沿用网页上次确认清单；盘中操作只接受自有代理或券商App的新真实时间戳。",
  "lastUpdated": "2026-09-01 12:30 北京时间（自有代理连接失败；无新的真实行情）",
  "apiBase": "https://daily-briefing-blue.vercel.app",
  "refreshInterval": 10000,
  "oneLine": "结论：9月1日不买；12:30自有代理连接失败，网页不产生盘中交易依据。仅在券商App或恢复后的自有代理给出新真实时间戳时，才核对164701的1.708、562350的1.081和161226的1.940/同日溢价。8月31日静态收盘不替代盘中价，所有卖出资金先留现金。仅供个人复盘参考。",
  "tradeDecision": [
    {
      "type": "第一屏结论",
  ...
  "sources": [
    {
      "name": "本次运行：自有代理连通性核验",
      "url": "https://daily-briefing-blue.vercel.app/api/quote?symbol=SH601208",
      "note": "2026-09-01 12:30北京时间，本环境连接代理失败，未写入任何新的价格、涨跌幅或K线；运行时页面应显示行情获取失败并允许重试真实行情。"
    },
    {
